                    ...
                    <div id="admin_module" style="display: none !important;" class="menu_on_off d-flex align-items-center flex-column justify-content-start  w-100 h-100">
                        <div class=" p-5 h-13 w-100  d-flex align-items-start flex-column justify-content-center ">
                            <h3 class="w-50 mt-3 ml-2"> Modules </h3>
                                       ...
                                       if($con)
                                        {
                                            ...
                                            while($row = mysqli_fetch_array($result))
                                            {
                                             ...
                                             <p class="attend-nav-text m-0 p-2">
                                                 <i id="', $row['mod_id'],'"  class="fa fa-pencil-square adm-mod-edit-btn " aria-hidden="true"></i>
                                                 <i id="', $row['mod_id'],'"  class="fa fa-trash adm-mod-delete-btn  pl-2" aria-hidden="true"></i>
                                             </p>
                                            </div>';
                        ...
                        <div class=" p-5 h-13 w-100  d-flex align-items-start flex-column justify-content-center ">
                            <button class="menu_on_off_button input_btn w-max-c " button_for="adm_add_mod" style="margin-top: 11px;">Add Module</button>
                        </div>
                    </div>
