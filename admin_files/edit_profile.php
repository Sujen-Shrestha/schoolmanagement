...
<div id="admin_edit" style="display: none !important;"class="menu_on_off d-flex align-items-center flex-row justify-content-start  w-100 h-100">
                        <div class="w-50 h-100  d-flex align-items-center flex-column justify-content-center">
                            ...
                            echo 
                            '                                   
                            <form  class="d-flex align-items-center flex-column justify-content-center w-100" action="./phpActionFiles/edit_profile_action.php"  method="post">
                        ...
                        <?php
                            ...
                            ?>
                            <p class="mt-4 cursor-p" data-toggle="modal" data-target="#exampleModal1">Choose different picture</p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style="color:black;" id="exampleModalLabel">Upload Profile Picture</h5>
      ...
      <div class="modal-body">
        <input type="file"style="color:black;"   id="myFile" class="after_file" name="file" placeholder="Select file" />
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="submit_p" id="save_btn"  data-dismiss=""  class="btn btn-primary">Save changes</button>
      </div>
      </form>
    </div>
  </div>
