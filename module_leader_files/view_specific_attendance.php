                                       ...
                                       if($con)
                                        {
                                            ...
                                            while($row6 = mysqli_fetch_array($result6))
                                            {
                                                ...
                                                if($row7 = mysqli_fetch_array($result7))
                                                {
                                                    $result2 = mysqli_query($con , "select *from attendance_data where attendance_id='$id' and student_id='$std_id'");
                                                    ...
                                                    if($row2 = mysqli_fetch_array($result2))
                                                    {
                                                        ...
                                                        if($row2['status'] == "X")
                                                        {
                                                            echo '<span class="mod-l-attend-c-box">
                                                            <i   attend_value="X" style="color:rgb(9, 243, 9);" class="  fa fa-check-circle-o mod-l-attend-c" aria-hidden="true"></i>
                                                        </span>';
                                                        }
                                                        else
                                                        {
                                                            echo '<span class="mod-l-attend-c-box">
                                                            <i   attend_value="" style="color:white;" class="  fa fa-check-circle-o mod-l-attend-c" aria-hidden="true"></i>
                                                        </span>';
                                                        }
                                                        ...
                                                        {
                                                            echo '<span class="mod-l-attend-c-box">
                                                            <i attend_value="O" style="color:blue;" class="attendance fa fa-circle-o mod-l-attend-c" aria-hidden="true"></i>
                                                        </span>';
                                                        }
                                                        else
                                                        {
                                                            echo '<span class="mod-l-attend-c-box">
                                                            <i attend_value="" style="color:white;" class="attendance fa fa-circle-o mod-l-attend-c" aria-hidden="true"></i>
                                                        </span>';
                                                        }
                                                        ...
                                                        {
                                                            echo '<span class="mod-l-attend-c-box">
                                                            <i    attend_value="A" style="color:red;" class="attendance  fa fa-times-circle mod-l-attend-c" aria-hidden="true"></i>
                                                        </span>';
                                                        }
                                                        else
                                                        {
                                                            echo '<span class="mod-l-attend-c-box">
                                                            <i    attend_value="" style="color:white;" class="attendance  fa fa-times-circle mod-l-attend-c" aria-hidden="true"></i>
                                                        </span>';
                                                        }
