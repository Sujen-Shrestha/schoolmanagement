                ...
                <div id="admin_edit" style="dissplay: none !important;"
                    ...
                    <div class="w-50 h-100  d-flex align-items-center flex-column justify-content-center">
                        ...
                        <?php
                            ...
                            <input class="input_field w-50 mt-4" name="fname" type="text" placeholder="First name" value="' , $row['student_firstname'],'" />
                            <input class="input_field w-50" type="text" name="lname" placeholder="Last name" value="' , $row['student_surname'],'" />
